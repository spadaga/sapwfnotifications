...
// ... approveWorkflow and rejectWorkflow functions remain the same ...
...
function createIndividualApprovalCard(workflow, isLiveData = true) {
  try {
    ...
    // --- UPDATED: Use VERCEL_URL for the callback endpoint ---
    // Vercel automatically sets this environment variable.
    // It will be something like 'sap-workflow-poc-ayush.vercel.app'
