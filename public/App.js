  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-md p-8 border border-gray-200">
        ...
        <p className="text-gray-600 mb-8">Click the button to simulate an SAP workflow. This will trigger the backend to generate an Adaptive Card and, in a production environment, send it to a Microsoft Teams channel.</p>
        ...
        {result && (
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border">
            ...
            <pre className="text-sm text-gray-800 bg-white p-4 rounded-md shadow-inner overflow-x-auto whitespace-pre-wrap break-words">{result}</pre>
          </div>
        )}
      </div>
    </div>
